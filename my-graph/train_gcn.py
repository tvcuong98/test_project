...
from models.GCN import GCNConv,GCNRegression
...
output_dir = "my-graph/output_gcn"
if not os.path.exists(output_dir):
    os.makedirs(output_dir)
def plotting_parity(T_pred,T_test,fold,name="GCN"):
...
for fold in range(5):
    ...
    r2_list=[]
    mae_list=[]
    model = GCNRegression(4,4).to(device)
    ...
    plotting_parity(all_outputs,all_labels,fold,name="GCN")
